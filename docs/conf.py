# -*- coding: utf-8 -*-
#
# hybcast documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    ('index',
     'hybcast.tex',
     u'hybcast Documentation',
     u"Sang TTruong", 'manual'),
]
...
man_pages = [
    ('index', 'hybcast', u'hybcast Documentation',
     [u"Sang TTruong"], 1)
]
