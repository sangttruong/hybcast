...
sys.path.append(os.getcwd()+"\\src\\data\\")
...
def main(args):
  ...
  if config['data_parameters']['frequency'] == 'Y': config['data_parameters']['frequency'] = None
  ...
  if args.input_directory == None: args.input_directory = os.getcwd() + "\\data\\external"
  else: assert os.path.isfile(args.input_directory), "No available path. Please try again"
...
if __name__ == '__main__':
  ...
  parser.add_argument("--input_directory", required=False, type=str,
